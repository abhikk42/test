<template>
  <div class="headContainer">
    <div class="firstHeader">
      <div class="headLeft">
        <h5>COMPLIMENTARY GIFT BOX PACKING ON ALL PRE-PAID ORDERS</h5>
      </div>
      <div class="headRight">
        <div class="list">
          <h5>Our Stores</h5>
    ...
    <div class="midHeader">
      ...
      <div class="rightList">
        ...
        <div class="icons">
          <img src="@/assets/bag.svg" class="selicon" />

          <img src="@/assets/like.svg" class="selicon" />
          <img src="@/assets/search.svg" class="selicon" />
        </div>
      </div>
    </div>
    <div
    ...
    >
      <div class="mobilemenu">
        <div class="mobilemenuhead">
          ...
          <button class="btncross" v-on:click="handleMobileMenu()">
...
.headContainer {
  ...
  overflow: hidden;
  align-items: center;
  box-shadow: 0px 3px 5px #dfdfdf66;
  font-family: "Jost";
  width: 100%;
}
...
.firstHeader > .headLeft,
.firstHeader > .headRight {
  width: 50%;
  height: 100%;
  align-items: center;
  display: inline-flex;
